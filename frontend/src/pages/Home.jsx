    ...
    return (
        <Fragment>
            ...
            <div id="products" className="container mt-1 pt-0 text-xl w-auto">
                <h1 id="products" className='flex justify-center font-semibold text-3xl p-4 mt-12 w-auto text-black text-start border-b-2 border-green-300'>Latest Products <span className='pl-2'><Search /></span></h1>
